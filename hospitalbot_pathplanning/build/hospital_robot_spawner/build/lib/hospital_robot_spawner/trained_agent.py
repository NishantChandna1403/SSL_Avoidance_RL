...
def main(args=None):
    ...
    pkg_dir = '/home/nishant/Desktop/Projects/Navigation_/hospitalbot_pathplanning/src/Hospitalbot-Path-Planning/hospital_robot_spawner'
    trained_model_path = os.path.join(home_dir, pkg_dir, 'rl_models', 'PPO_second_generation')
